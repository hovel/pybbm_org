...
def fu():
    with cd(PROJECT_ROOT):
        ...
        run('%s/env/bin/python %s/manage.py migrate captcha' % (PROJECT_BASEDIR, PROJECT_ROOT))
        run('%s/env/bin/python %s/manage.py migrate pybb' % (PROJECT_BASEDIR, PROJECT_ROOT))
